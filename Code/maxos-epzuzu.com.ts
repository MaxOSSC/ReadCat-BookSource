...
plugin.exports = class Plugin implements BookSource {
   ...
   */
  public static readonly ID: string = "2GB0Yjp2VjEBZJz_Yx9EC";
  /**
   * 静态属性 TYPE  必填
   * 插件类型
   * 值类型:
  ...
  public static readonly PLUGIN_FILE_URL: string =
    "https://raw.kkgithub.com/MaxOSSC/ReadCat-BookSource/main/Plugin/maxos-epzuzu.com.ts.js";
  /**
   * 静态属性 BASE_URL  必填
   * 插件请求目标链接
   */
  public static readonly BASE_URL: string = "https://www.epzuzu.com";
  /**
   * 静态属性 REQUIRE  可选
   * 要求用户填写的值
   */
